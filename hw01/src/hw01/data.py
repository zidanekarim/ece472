...
class Data:
    ...
    def __post_init__(self, rng: np.random.Generator):
        ...
        self.x = rng.uniform(
            0, 1.0, size=(self.num_samples, self.num_features)
        )  # manually changed from (0.1, 0.9) to (0, 1), to reflect assignment specs
        ...
        ).flatten()  # this produces the + epsilon_i from my understanding
